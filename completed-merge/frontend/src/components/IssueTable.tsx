    ...
    <div className="mp-table-border-wrapper">
      <table className="mp-issues-table">
        ...
        <tbody className="mp-table-body">
          {issues.map(issue => (
            <tr key={issue.id} className="mp-table-row">
              <td className="mp-td-center">
                <button onClick={() => onToggleFavorite(issue.id)} type="button" className="mp-favorite-btn" aria-label="Favorite issue">
              ...
              <td className="mp-td-title" title={issue.title}>{issue.title}</td>
              <td>
              ...
              <td>
                {issue.assignee ? (
                  <div className="mp-flex-center mp-gap-2">
                    <span className="mp-avatar-circle">{issue.assignee.initial}</span>
